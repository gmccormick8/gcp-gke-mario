...
module "cluster-central" {
  ...
  pods_cidr              = module.prod-vpc.secondary_ranges["prod-central-vpc"][0].ip_cidr_range
  services_cidr          = module.prod-vpc.secondary_ranges["prod-central-vpc"][1].ip_cidr_range
