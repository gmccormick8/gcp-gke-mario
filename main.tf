...
module "cluster-central" {
  ...
  pods_cidr              = module.prod-vpc.secondary_ranges["prod-central-vpc"].secondary_ranges[0]
  services_cidr          = module.prod-vpc.secondary_ranges["prod-central-vpc"].secondary_ranges[1]
